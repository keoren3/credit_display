...
from db_handler import insert_transactions_db
...
def parse_args():
    ...
    parser.add_argument('--sheet_name', help='sum the integers (default: find the max)',
                        default="new_one.xls", required=False)
...
def create_data(sheet, curr_workbook):
    ...
    for i in range(sheet.nrows):
        ...
        [date, bussines_name, deal_value, chrage_value, another_deatils] = [
...
def main():
    ...
    transactions_arr = create_data(first_sheet, curr_workbook)

    db_con = connect_to_db(
        "mongodb+srv://imridb:imri123!@creditdata-xurnm.mongodb.net/test", "test-collection")
    print("Connected!")
    insert_transactions_db(db_con, transactions_arr)
